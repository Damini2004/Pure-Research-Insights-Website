// src/components/conference-detail-client.tsx
"use client";

import * as React from "react";
import { useEffect, useState } from "react";
import { getConferenceByShortTitle } from "@/services/conferenceService";
...
export default function ConferenceDetailClient({ slug }: { slug: string }) {  
  ...
  useEffect(() => {
    const fetchConference = async () => {
      ...
      setIsLoading(true);
      try {
        const result = await getConferenceByShortTitle(slug);
